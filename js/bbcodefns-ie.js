...
function subscript() {
    if (helpmode) {
        ...
        AddText('', '', "[sub]"+document.selection.createRange().text+"[/sub]", messageElement);
    } else {
        txt=prompt(bbcode_prompt_subscript,"Text");
        if (txt!=null) {
            AddText('', '', "[sub]"+txt+"[/sub]", messageElement);
        }
    }
}
...
function superscript() {
    if (helpmode) {
        ...
        AddText('', '', "[sup]"+document.selection.createRange().text+"[/sup]", messageElement);
    } else {
        txt=prompt(bbcode_prompt_superscript,"Text");
        if (txt!=null) {
            AddText('', '', "[sup]"+txt+"[/sup]", messageElement);
        }
    }
}
